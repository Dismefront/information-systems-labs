  ...
  public ResponseEntity updloadYamlFile(@RequestBody String yamlContent, Principal principal) {
    ...
    try {
      ...
      minioService.uploadFile(
          bucketName, fileName, fileStream, yamlContent.getBytes().length, "application/x-yaml");
      ...
      ArrayList<Map<String, Object>> products =
          (ArrayList<Map<String, Object>>) yamlData.get("products");
      ...
      if (importHistory == null) {
        try {
          ...
          System.err.println(
              "Failed to delete file from MinIO during rollback: " + ex.getMessage());
        }
      }
