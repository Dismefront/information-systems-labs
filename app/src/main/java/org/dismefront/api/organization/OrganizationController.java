...
public class OrganizationController {
  ...
  public ResponseEntity add(
      @RequestBody OrganizationRequest organizationRequest, Principal principal) {
    ...
    try {
      ...
      return ResponseEntity.ok()
          .body(organizationService.saveOrganization(organizationRequest, username));
    } catch (Exception e) {
  ...
  public ResponseEntity update(
    ...
    try {
      ...
      return ResponseEntity.ok()
          .body(organizationService.updateOrganization(organizationRequest, username, id));
    } catch (Exception e) {
      return ResponseEntity.badRequest().body(e.getMessage());
    }
  }
  ...
  public ResponseEntity list(@RequestParam int page, @RequestParam int size, Principal principal) {
    ...
    return ResponseEntity.ok()
        .body(organizationService.getOrganizationList(page, size, principal.getName(), isAdmin));
  }
}
