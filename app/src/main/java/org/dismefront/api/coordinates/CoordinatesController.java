...
public class CoordinatesController {
  ...
  public ResponseEntity add(
      @RequestBody CoordinatesRequest coordinatesRequest, Principal principal) {
    ...
    try {
      ...
      return ResponseEntity.ok()
          .body(coordinatesService.saveCoordinates(coordinatesRequest, username));
    } catch (Exception e) {
  ...
  public ResponseEntity update(
    ...
    if (eventRepository
            .findByNameAndActorAndEntityId(EventName.COORDINATE_CREATED, username, id)
            .isEmpty()
    ...
    try {
      ...
      return ResponseEntity.ok()
          .body(coordinatesService.updateCoordinates(coordinatesRequest, username, id));
    } catch (Exception e) {
      return ResponseEntity.badRequest().body(e.getMessage());
    }
  }
  ...
  public ResponseEntity list(@RequestParam int page, @RequestParam int size, Principal principal) {
    ...
    return ResponseEntity.ok()
        .body(coordinatesService.getCoordinatesList(page, size, principal.getName(), isAdmin));
  }
}
