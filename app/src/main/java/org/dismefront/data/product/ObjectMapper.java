...
public class ObjectMapper {
  ...
  public void setCoordinatesParamsFromMap(
      Coordinates coordinates, Map<String, Object> coordinatesParams) {
  ...
  public void setOrganizationParamsFromMap(
      Organization organization, Map<String, Object> organizationParams) {
    ...
    if (organizationParams.get("officialAddressId") != null) {
      ...
      setAddressParamsFromMap(
          officialAddress, (Map<String, Object>) organizationParams.get("officialAddress"));
    ...
    if (organizationParams.get("postalAddressId") != null) {
      ...
      setAddressParamsFromMap(
          postalAddress, (Map<String, Object>) organizationParams.get("postalAddress"));
  ...
  public void setProductParamsFromMap(Product product, Map<String, Object> productParams) {
    ...
    if (productParams.get("coordinatesId") != null) {
      ...
      setCoordinatesParamsFromMap(
          coordinates, (Map<String, Object>) productParams.get("coordinates"));
    ...
    if (productParams.get("manufacturerId") != null) {
      ...
      setOrganizationParamsFromMap(
          organization, (Map<String, Object>) productParams.get("manufacturer"));
