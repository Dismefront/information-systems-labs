...
public interface AddressRepository extends JpaRepository<Address, Long> {
    @Query(value = "SELECT new org.dismefront.data.address.AddressManaged(a.id, a.zipCode, a.town, " +
            ...
            countQuery = "SELECT COUNT(p) FROM Address p LEFT JOIN Event e ON e.entityId = p.id AND e.name = :eventName")
