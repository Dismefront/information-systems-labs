...
public interface CoordinatesRepository extends JpaRepository<Coordinates, Long> {
    @Query(value = "SELECT new org.dismefront.data.coordinates.CoordinatesManaged(c.id, c.x, c.y, " +
            ...
            countQuery = "SELECT COUNT(p) FROM Coordinates p LEFT JOIN Event e ON e.entityId = p.id AND e.name = :eventName")
