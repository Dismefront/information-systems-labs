...
import org.dismefront.app.exception.ResourceNotFoundException;
...
public class OrganizationService {
  ...
  public Organization updateOrganization(
      OrganizationRequest organizationRequest, String username, Long organizationId) {
  ...
  private void organizationParams(
      OrganizationRequest organizationRequest, Organization organization) {
    organization.setName(organizationRequest.getName());
    organization.setOfficialAddress(
        addressRepository.getReferenceById(organizationRequest.getOfficialAddressId()));
    ...
    organization.setPostalAddress(
        addressRepository.getReferenceById(organizationRequest.getPostalAddressId()));
  }
  ...
  public void deleteOrganization(Long id, String username) {
    ...
    Event event =
        new Event(
            EventName.ORGANIZATION_DELETED, username, id, new Timestamp(new Date().getTime()));
    eventRepository.save(event);
  }

  public Page<OrganizationManaged> getOrganizationList(
      int page, int size, String username, boolean isAdmin) {
    Pageable pageable = PageRequest.of(page, size);
    return organizationRepository.findOrganizationsWithEditableFlag(
        username, EventName.ORGANIZATION_CREATED, isAdmin, pageable);
  }
}
