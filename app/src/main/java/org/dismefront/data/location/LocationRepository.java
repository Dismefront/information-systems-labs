...
public interface LocationRepository extends JpaRepository<Location, Long> {
  @Query(
      value =
          "SELECT new org.dismefront.data.location.LocationManaged(l.id, l.x, l.y, l.z, "
      ...
      countQuery =
          "SELECT COUNT(p) FROM Location p LEFT JOIN Event e ON e.entityId = p.id AND e.name = :eventName")
  Page<LocationManaged> findLocationsWithEditableFlag(
